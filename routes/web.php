...
Route::group(['namepace' => 'App\Http\Controllers\Personal', 'prefix' => 'personal', 'middleware' => ['auth', 'verified']], function () {
    ...
    Route::group(['namespace' => 'App\Http\Controllers\Personal\Comment', 'prefix' => 'comments'], function () {
...
Route::group(['namepace' => 'App\Http\Controllers\Admin', 'prefix' => 'admin', 'middleware' => ['auth', 'admin', 'verified']], function () {
