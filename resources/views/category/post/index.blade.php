            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="{{ route('post.index')}}">Main</a>
                            @guest()
                            <a class="navbar-brand" href="{{ route('personal.main.index')}}">Login</a>
                            @endguest
                            @auth()
                            <a class="navbar-brand" href="{{ route('personal.main.index')}}">Personal cabinet</a>
                            @endauth
